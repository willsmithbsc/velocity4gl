...
export interface ControlFileRepository {
...
export function parseControlFile(text: string): ControlFileRepository {
                    ...
                    if (fieldMatch) {
                        ...
                        if (attrStr) {
                            ...
                            while ((attrMatch = attrRegex.exec(attrStr)) !== null) {
                                const k = attrMatch[1];
                                let v: any = attrMatch[2];
                                if (k === 'sorted') { v = v === 'true'; }
                                if (k === 'ranges') { v = v.split('|'); }
                                attrs[k] = v;
                            }
                        }
